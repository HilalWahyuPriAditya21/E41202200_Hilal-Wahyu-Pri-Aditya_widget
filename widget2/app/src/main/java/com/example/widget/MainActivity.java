...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String[] Hewan = new String[]{
            "Ayam", "Kelelawar", "Kambing", "Monyet",
            "Tupai", "Biawak", "Ikan", "Sapi",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Vertebrata, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, Hewan);
